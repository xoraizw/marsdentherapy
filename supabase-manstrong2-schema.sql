-- ManStrong2 CRM Database Schema
...
-- Appointments Table
-- Note: All appointments are with Dr. Suren Naidoo (the owner/doctor)
CREATE TABLE IF NOT EXISTS appointments (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    session_id TEXT NOT NULL,
    lead_id UUID REFERENCES leads(id),
    doctor_name TEXT DEFAULT 'Dr. Suren Naidoo', -- Always Dr. Naidoo
